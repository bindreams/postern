...
# Builds the per-connection tunnel image (compose does not build it), brings up the
# rest of the stack, and verifies the result. Non-zero exit means something did not
# actually deploy.
scripts/deploy.sh
