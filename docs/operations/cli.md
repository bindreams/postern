...
`--plugin` selects the SIP003 plugin: `v2ray-plugin` (default) or `galoshes`, which adds UDP support via yamux. Tell galoshes users they need v0.4.0 or newer — older binaries cannot connect (see [connecting](../connecting.md)):
