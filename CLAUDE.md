...
- **OpenAPI is disabled on purpose.** [app.py:52](portal/src/postern/app.py#L52): `docs_url=None, redoc_url=None, openapi_url=None`. There is no public API surface. Do not re-enable.
